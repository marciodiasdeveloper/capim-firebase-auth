import { Controller, TasksShowController } from '@/application/controllers'
...
describe('TasksShowController', () => {
  let sut: TasksShowController
  ...
  beforeEach(() => {
    sut = new TasksShowController(sutAuthorizationToken)
  })
